...
L[" you are now the Master Looter and ScroogeLoot is now handling looting."] = true
...
L["Always use ScroogeLoot when I'm Master Looter"] = true
...
L["Candidate has disabled ScroogeLoot"] = true
...
L["chat tVersion string"] = "|cFF87CEFAScroogeLoot |cFFFFFFFFversion |cFFFFA500 %s - %s"
L["chat version String"] = "|cFF87CEFAScroogeLoot |cFFFFFFFFversion |cFFFFA500 %s"
L["chat_commands"] = [=[
...
L["Choose when to use ScroogeLoot"] = true
...
L["Close"] = true
L["config"] = true
L["confirm_usage_text"] = "|cFF87CEFA ScroogeLoot |r\n\nWould you like to use ScroogeLoot with this group?"
...
L["enable_loot_history_desc"] = "Enables the history. ScroogeLoot won't log anything if disabled."
...
L["ignore_input_desc"] = "Enter an itemID to add to the ignore list causing ScroogeLoot to never add the item to a session"
L["ignore_input_usage"] = "This function only accepts itemIDs (number)"
L["ignore_list_desc"] = "Items ScroogeLoot is ignoring. Click on a item to remove it."
L["ignore_options_desc"] = "Control which items ScroogeLoot should ignore. If you add an item that isn't cached, you need switch to another tab and back before you'll see it in the list."
L["ilvl"] = true
L["ilvl: x"] = "ilvl: %d"
...
L["Won 'item'"] = "Won: %s"
L["Item won for 'roll':"] = "Item won for %s:" 
L["Log"] = true
...
L["loot_history_desc"] = "ScroogeLoot automatically records relevant information from sessions.\nThe raw data is stored in \".../SavedVariables/ScroogeLoot.lua\".\n\nNote: Non-MasterLooters can only store data sent from the MasterLooter.\n"
...
L["Officer"] = true
L["Offline or ScroogeLoot not installed"] = true
...
L["Raid"] = true
L["Rank"] = true
L["ScroogeLoot Loot Frame"] = true
L["ScroogeLoot Loot History"] = true
L["ScroogeLoot Session Setup"] = true
L["ScroogeLoot Version Checker"] = true
L["ScroogeLoot Voting Frame"] = true
L["Reannounce ..."] = true
L["Reason"] = true
...
L["Send History"] = true
L["send_history_desc"] = "Send data to everyone in the raid, regardless if you log it yourself. ScroogeLoot will only send data if you're the MasterLooter."
...
L["tVersion_outdated_msg"] = "Newest ScroogeLoot test version is: %s"
...
L["version_outdated_msg"] = "Your version %s is outdated. Newer version is %s, please update ScroogeLoot."
L["Vote"] = true
L["Voters"] = true
L["Votes"] = true
...
L["whisper"] = true
L["whisper_guide"] = "[ScroogeLoot]: number response [item1] [item2]. Link your item(s) that item (number) would replace, (response) being of the keywords below: Ex. '1 Greed [item1]' would greed on item #1"
L["whisper_guide2"] = "[ScroogeLoot]: You'll get a confirmation message if you were successfully added."
L["whisper_help"] = "Raiders can use the whisper system in case someone haven't installed the addon.\nWhispering 'slhelp' to the Master Looter will get them a guide along with the list of keywords, which can be edited at the 'Buttons and Responses' optiontab.\nIt's recommended for the ML to turn on 'Announce Considerations' as each item's number is required to use the whisper system.\nNOTE: People should still get the addon installed, otherwise all player information won't be available."
